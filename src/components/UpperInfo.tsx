  ...
  return (
    <div>
      <div className='flex justify-around text-black  '>
        <div className='w-[100%] bg-white text-center xl:pt-[1rem] xxs:py-[2rem] flex flex-col justify-between'>
        ...
        <div className='w-[100%] bg-stone-300 text-center xl:pt-[1rem] xxs:py-[2rem] '>
          <div className='flex w-[100%] flex-col justify-between'>
            <h1 className='text-[1.25rem] pt-4 md:text-[1.5rem] lg:text-[2rem] md:mt-5 font-bold'>
              Vote For MPS
            </h1>
